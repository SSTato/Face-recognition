...
if __name__ == "__main__":
    ...
    pppp = open(os.path.abspath('parameter.txt'), 'r').read().splitlines()[0].split('ip:')[1]
    video_path      = 'rtsp://admin:abc12345@192.168.1.71/Streaming/Channels/1'
    video_save_path = ""
    video_fps       = 25.0
    #-------------------------------------------------------------------------#
